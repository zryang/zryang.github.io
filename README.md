...
###  我的博客，[山夕为岁→](https://zryang.github.io/)

![](https://i.loli.net/2018/04/07/5ac86b986a3ce.png)
...
email: yzr2064@gmail.com
description: "你来人间一趟，你要看看太阳"
keyword: "Shaun Young, code, OJ"
url: "http://zryang.github.io"              # your host, for absolute URL
baseurl: ""                             # for example, '/blog' if your blog hosted on 'host/blog'


# SNS settings
RSS: false
weibo_username:     3880187756
zhihu_username:     lu-sheng-83-99
github_username:    zryang
twitter_username:   ZeroYounger
facebook_username:  ZorroYoung
...
看右边:
![](https://i.loli.net/2018/04/07/5ac86ff091d47.png)

设置是在 `_config.yml`文件里面的`Sidebar settings`那块。
```
# Sidebar settings
sidebar: true            # whether or not using Sidebar.
sidebar-about-description: "读书，跑步，编程，画画"
sidebar-avatar: /img/shaun.jpg      # use absolute URL, seeing it's used in both `/` and `/about/`
...
网站分析，现在支持百度统计和Google Analytics。需要去官方网站注册一下，然后将返回的code贴在下面。我的还没搞好，参考一下HuxPro的：
...
如果你喜欢折腾，你可以去自定义这个模板的 code，[Grunt](gruntjs.com)已经为你准备好了。（感谢 Clean Blog）
...
我的博客标题是 **“山夕为岁”** 但是我想要在搜索的时候显示 **“Shaun Young”** ，这个就需要SEO Title来定义了。

其实这个SEO Title就是定义了<head><title>标题</title></head>这个里面的东西和多说分享的标题，你可以自行修改的。

## 致谢

1.这个博客是fork自**柏荧**[qiubaiying](https://github.com/qiubaiying/qiubaiying.github.io) ，柏荧的博客是fork自**黄玄**[Huxpro](https://huangxuan.me/) ，黄玄的博客借鉴自[BlackrockDigital](http://blackrockdigital.github.io/startbootstrap-clean-blog-jekyll/) 。感谢他们！

2.主要工具为Github Pages，Jekyll，感谢！
